...
public static class ValidatorFactories
{
    ...
    public static Func<string, Validated<string>> CreateTitleValidator<T>() where T : notnull

        => CreateRegexValidator<string>(@"^(Mr|Mrs|Ms|Dr|Prof)$", "Title", "Title", "Must be one of Mr, Mrs, Ms, Dr, Prof");

    public static Func<string, Validated<string>> CreateGivenNameValidator<T>() where T : notnull
    ...
    public static Func<string, Validated<string>> CreateFamilyNameValidator<T>() where T : notnull
